...
The skill file is in this repo:

- **Cursor**: copy `autoresearch-universal/SKILL.md` to `~/.cursor/skills/autoresearch-universal/SKILL.md`
- **Claude Code**: copy `autoresearch-universal/SKILL.md` to `~/.claude/skills/autoresearch-universal/SKILL.md`
