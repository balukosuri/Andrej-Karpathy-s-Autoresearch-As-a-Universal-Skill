...
```
Andrej Karpathy's autoresearch as a skill/
├── README.md               ← You are here
├── ARTICLE.md              ← Full story of how this skill was built
├── cursor/
│   └── SKILL.md            ← Skill file for Cursor IDE
└── claude-code/
    └── SKILL.md            ← Skill file for Claude Code CLI
```

Both `SKILL.md` files are identical. They're separated for easy installation into each platform.
...
```bash
# Copy the skill to your global Cursor skills directory
cp -r cursor/SKILL.md ~/.cursor/skills/autoresearch-universal/SKILL.md
```
...
cp cursor/SKILL.md ~/.cursor/skills/autoresearch-universal/SKILL.md
```
...
cp claude-code/SKILL.md ~/.claude/skills/autoresearch-universal/SKILL.md
```
...
2. **Suggest 5-8 optimization targets** — tailored to your specific codebase
